  ...
  return (
    <div className='w-full  min-h-0  p-2 mt-10 grid grid-cols-2 dark:dark:text-customText-dark'>
        <div className='flex items-start justify-start flex-col p-4 relative'>
            ...
            <button onClick={()=>redirect_route('accounts/signup')}  className='w-[200px] flex items-center justify-center h-[50px] rounded-[40px] mt-4 hover:text-white bg-customMaincolors-primary'><span>get started</span> &nbsp;<GrFormNextLink /></button>
