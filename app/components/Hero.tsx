...
function Hero() {
  return (
    <div className='w-full  min-h-0  p-2 mt-10 grid grid-cols-2'>
        <div className='flex items-start justify-start flex-col p-4 relative'>
            ...
            <p className='leading-7 text-sm my-4 w-[80%] tracking-narrower text-customText-light'>Hey,there are you struggling to start or maintain a good reading culture or you can't remember most things you learnt from a book the moments you finish reading it.We will help you change that,Start the journey with us today for <span className='font-extrabold text-customMaincolors-primary'>free</span> </p>
            ...
            <span className='text-gray-500 text-[11px] ml-4'>💳 no credit card required</span>
